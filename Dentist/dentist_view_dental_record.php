...
$q1 = "SELECT * FROM dentalrecord WHERE recordID='$id'";

if($r=mysqli_query($conn,$q1)){
    if(mysqli_num_rows($r)==1){
        $row=mysqli_fetch_array($r);

        echo '<h1 style="text-align: center; margin-top: 50px;">Dental Record Details</h1>';
        ...
        <label><span class="profile"> Treatment: </span>'. $row['treatment'].'</label><br>
