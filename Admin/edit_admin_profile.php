...
$conn = mysqli_connect('localhost', 'DentalSystem', 'dental2024', 'dentaldb') or die('Unable to connect: ' . mysqli_connect_error());
include('Admin.php');
...
$adminQuery = "SELECT a.*, u.name, u.email, l.username, l.password
               FROM Admin a
               JOIN User u ON a.userID = u.userID
               JOIN Login l ON u.userID = l.fk_userid
               WHERE a.userID = '$userID'";
$adminResult = mysqli_query($conn, $adminQuery);
$row_user = mysqli_fetch_assoc($adminResult);
        ...
        * {
        ...
        body {
            ...
            background: 
                ...
                url('../images/background_admin.jpg'); 
...
<body>
    ...
    <div class="container">
        <div class="profile-header">
            <img src="../images/Admin_icon.png" alt="Admin Logo">
        ...
        <div class="edit-form" id="editForm">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="profile-info">
                    ...
                    <input type="password" name="password" value="<?= md5($password) ?>" required>
                </div>
                <div class="profile-info">
                    <div class="label">Qualification</div>
